          ...
          <div className="education">
            <div className="education-header">
              ...
              <div className="education-description">
                ...
                <span className="time-period">September 2022 - June 2026</span>
              </div>
            </div>
            ...
            <div className="education-info">
              ...
              <div className="course-work">
                Relevant coursework include Web Application Development,
                Software Engineering Process, Data Structures, Database
                Management, and Operations Research.
              </div>

              <div className="activities">
                Active member of Google Developers Student Club, Nile Model UN,
                National Association of Computing Students (NACOS), and Nile
                Christian Fellowship, gaining valuable teamwork and leadership
                experience.
              </div>
            </div>
          </div>
